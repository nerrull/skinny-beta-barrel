...
int main(int argc,char*argv[]) {
	...
	const char* tmpg03[] = { "2mpr", "1a0s", "2omf", "2por", "1prn", "1e54", "2o4v", "3vzt", "4k3c", "4k3b", "4c4v", "4n75", "3emn" };
	const char* tmpg04[] = { "2qdz", "2ynk", "3rbh", "3syb", "3szv", "4c00", "4gey", "3emn" };
	...
	vector<string> g03(tmpg03, tmpg03+13);
	//vector<string> g04(tmpg04, tmpg04+ 7);
	vector<string> g04(tmpg04, tmpg04+ 8);
	vector<string> g05(tmpg05, tmpg05+10);
	if( find(g01.begin(), g01.end(), pdbs[0])!=g01.end() ){
		// default
	...
	else if( find(g02.begin(), g02.end(), pdbs[0])!=g02.end() ){
		// default
	...
	else if( find(g03.begin(), g03.end(), pdbs[0])!=g03.end() ){
		// default
	...
	else if( find(g04.begin(), g04.end(), pdbs[0])!=g04.end() ){
		// default
	...
	else if( find(g05.begin(), g05.end(), pdbs[0])!=g05.end() ){
		// default
	...
	for(wweak   = wweakl;   wweak   < wweaku;   wweak   += wweaks   )
	{
		...
		for(int pdbi=0 ; pdbi < pdb_num; pdbi++) {
			...
			//else if(pdbs[pdbi] == "2mpr" || pdbs[pdbi] == "1a0s" || pdbs[pdbi] == "2omf" || pdbs[pdbi] == "2por" || pdbs[pdbi] == "1prn" || pdbs[pdbi] == "1e54" || pdbs[pdbi] == "2o4v" || pdbs[pdbi] == "3vzt" || pdbs[pdbi] == "4k3c" || pdbs[pdbi] == "4k3b" || pdbs[pdbi] == "4c4v" || pdbs[pdbi] == "4n75" || pdbs[pdbi] == "3emn"){
				#ifdef ECPARAM110010080// ec 110010080
			...
			else if(pdbs[pdbi] == "2qdz" || pdbs[pdbi] == "2ynk" || pdbs[pdbi] == "3rbh" || pdbs[pdbi] == "3syb" || pdbs[pdbi] == "3szv" || pdbs[pdbi] == "4c00" || pdbs[pdbi] == "4gey" || pdbs[pdbi] == "3emn"){
				#ifdef ECPARAM110010080// ec 110010080
			...
			for(int strandi = 0; strandi < strand_num[pdbi]; strandi++) {
				...
				if(strand_num[pdbi]%2==1 && strandi==strand_num[pdbi]-1){
					continue;
				}
				/* //np1_left
				if(strandi%2==0){
				...
				*/ //np1_left
				...
				// determine pattern
				//HBondPattern hbond_pattern = patterning(pdbi, extras[strandi], orientation1); // np1_left
				HBondPattern hbond_pattern = patterning(pdbi, peris[strandi], orientation1); // np1_right
...
//////////////////////////////////////// core computation part
				...
				for(int regoffset=-10; regoffset <= 6; regoffset++) { 
					...
					double negative_reg = curr_predreg<=0 ? 0 : -curr_predreg; //np1_right
					//double negative_reg = curr_predreg>=0 ? 0 : curr_predreg; //np1_left
